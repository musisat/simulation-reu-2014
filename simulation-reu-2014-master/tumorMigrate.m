function tumorMigrate(x,y,x1,y1,index)
global tumorDensityFine tumorDensityCoarse tumorDataArray h n m tmax
global immuneDensityFine hostDensityFine hostDensityCoarse necroticDensityFine
...
if space > 0 % If there is a free grid space, choose a random one
    ...
    while done==0
        ...
        if tumorDensityFine(x2+i,y2+j)==0 && immuneDensityFine(x2+i,y2+j)==0
            ...
            tumorDensityFine(x2,y2)=tumorDensityFine(x2,y2)-1;
            ...
            tumorDataArray(index,2:5)=[x2+i y2+j x1_new y1_new];
